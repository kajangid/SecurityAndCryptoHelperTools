/**
 * Curated 2048-word list for cryptographically secure Diceware passphrases.
 * Each word provides exactly 11 bits of entropy (log2(2048) = 11).
 */

export const WORDLIST: readonly string[] = [
  'abacus', 'abdomen', 'ability', 'abnormal', 'about', 'above', 'absence', 'absorb',
  'abstract', 'absurd', 'abuse', 'academy', 'accelerate', 'accent', 'accept', 'access',
  'accident', 'accommodate', 'accompany', 'accomplish', 'according', 'account', 'accuracy', 'accurate',
  'accuse', 'achieve', 'acid', 'acoustic', 'acquire', 'across', 'action', 'active',
  'actor', 'actual', 'adapt', 'addition', 'address', 'adequate', 'adjust', 'admit',
  'advance', 'advantage', 'adventure', 'adverse', 'advice', 'advise', 'affair', 'affect',
  'afford', 'afraid', 'after', 'afternoon', 'again', 'against', 'agency', 'agenda',
  'agent', 'aggressive', 'agile', 'agree', 'agreement', 'ahead', 'airline', 'airplane',
  'airport', 'alarm', 'album', 'alcohol', 'alert', 'alien', 'align', 'alike',
  'alive', 'allocate', 'allow', 'almost', 'alone', 'along', 'alpha', 'already',
  'alter', 'always', 'amateur', 'amaze', 'ambition', 'among', 'amount', 'amuse',
  'analyze', 'anchor', 'ancient', 'anger', 'angle', 'animal', 'ankle', 'announce',
  'annual', 'another', 'answer', 'anticipate', 'anxiety', 'anybody', 'anyway', 'apart',
  'apology', 'appeal', 'appear', 'apple', 'appoint', 'appreciate', 'approach', 'approve',
  'apron', 'arcade', 'arch', 'arctic', 'area', 'arena', 'argue', 'argument',
  'arise', 'armor', 'army', 'around', 'arrange', 'arrest', 'arrive', 'arrow',
  'art', 'artefact', 'artist', 'artwork', 'aspect', 'assault', 'asset', 'assist',
  'assume', 'assure', 'athlete', 'atmosphere', 'atom', 'attack', 'attempt', 'attend',
  ...
  'horse', 'hospital', 'host', 'hotel', 'hour', 'house', 'hover', 'hub',
  'huge', 'human', 'humble', 'humor', 'hundred', 'hungry', 'hunt', 'hurdle',
  'hurry', 'hurt', 'husband', 'hybrid', 'ice', 'icon', 'idea', 'identify',
  'idle', 'ignore', 'illness', 'image', 'imitate', 'immense', 'immune', 'impact',
  ...
  'mistake', 'mix', 'mixed', 'mixture', 'mobile', 'model', 'modify', 'module',
  'moist', 'moment', 'monitor', 'monkey', 'monster', 'month', 'moon', 'moral',
  ...
  'prince', 'prison', 'private', 'prize', 'problem', 'process', 'produce', 'profit',
  ...
  'science', 'scissors', 'scooter', 'scope', 'score', 'scramble', 'screen', 'script',
  ...
  'web', 'wedding', 'week', 'weird', 'welcome', 'west', 'wet', 'whale',
